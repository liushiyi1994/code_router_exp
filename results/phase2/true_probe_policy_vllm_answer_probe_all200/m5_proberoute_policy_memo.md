...
```bash
python experiments/54_proberoute_policy.py --output-dir results/phase2/true_probe_policy_vllm_answer_probe_all200 --before-beliefs results/phase2/true_probe_policy_inputs_vllm_answer_probe_all200/true_probe_before_beliefs.csv --after-beliefs results/phase2/true_probe_policy_inputs_vllm_answer_probe_all200/true_probe_after_beliefs.csv --state-model-utility results/phase2/true_probe_policy_inputs_vllm_answer_probe_all200/true_probe_state_model_utility.csv --query-model-utility results/phase2/true_probe_policy_inputs_vllm_answer_probe_all200/true_probe_query_model_utility.csv --probe-cost results/phase2/true_probe_policy_inputs_vllm_answer_probe_all200/true_probe_cost.csv --predicted-gain results/phase2/true_probe_policy_inputs_vllm_answer_probe_all200/true_probe_predicted_gain.csv
```
