...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 41.0000 | 1.0000 | 0.0244 | 0.8537 | 0.8537 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.0000 | 0.1633 |
...
| artifact | path |
| --- | --- |
| summary | results/phase2/true_probe_decision_value_vllm_combined_probe_all200/table_true_probe_decision_value.csv |
| by_query | results/phase2/true_probe_decision_value_vllm_combined_probe_all200/table_true_probe_decision_value_by_query.csv |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| math500:test:8 | MiniCPM4.1-8B | Qwen3-8B | True | 1.0000 | 1.0000 | 0.0000 | 0.0000 | 0.1188 |
