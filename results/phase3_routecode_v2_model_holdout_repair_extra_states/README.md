...
| model_holdout_repaired_k16_diagnostic_true_state | 0.7412 | 0.7199 | 0.9839 | 0.0000 | {"gemini-3.5-flash": 10, "gpt-5.5": 10, "qwen3-14b-awq-local": 111, "qwen3-32b-awq-local": 20, "qwen3-4b-local": 15, "qwen3-8b-local": 4} |
| model_holdout_repaired_k24_diagnostic_true_state | 0.7412 | 0.7199 | 0.9839 | 0.0000 | {"gemini-3.5-flash": 10, "gpt-5.5": 10, "qwen3-14b-awq-local": 113, "qwen3-32b-awq-local": 18, "qwen3-4b-local": 15, "qwen3-8b-local": 4} |
...
| model_holdout_repaired_k16_knn_active_state_reveal | 0.5765 | 0.5596 | 0.7648 | 0.2294 | {"gemini-3.5-flash": 5, "gpt-5.5": 7, "qwen3-14b-awq-local": 121, "qwen3-32b-awq-local": 31, "qwen3-4b-local": 6} |
| model_holdout_repaired_k24_knn_active_state_reveal | 0.5765 | 0.5596 | 0.7648 | 0.2294 | {"gemini-3.5-flash": 5, "gpt-5.5": 7, "qwen3-14b-awq-local": 122, "qwen3-32b-awq-local": 30, "qwen3-4b-local": 6} |
...
| model_holdout_repaired | 24 | knn | 0.2824 | 0.3935 | 0.1532 | 0.2294 | 0.3206 |
| model_holdout_repaired | 16 | knn | 0.2765 | 0.3939 | 0.1611 | 0.2294 | 0.3130 |
...
| model_holdout_repaired_k16_knn_semantic_or_lowconf_remote_gate | 0.6667 | 0.3319 | 0.6041 | 0.9333 | {"gpt-5.5": 14, "qwen3-4b-local": 1} |
...
| model_holdout_repaired_k16_knn_plain_predicted_state | 0.0667 | 0.0607 | 0.1104 | 0.4000 | {"gpt-5.5": 1, "qwen3-4b-local": 14} |
...
```bash
PYTHONPATH=src python experiments/246_phase3_routecode_v2_state_pipeline.py --output-dir results/phase3_routecode_v2_model_holdout_repair_extra_states --state-methods raw_kmeans relative_kmeans calibration_refined model_holdout_repaired --k-values 16 24 --predictors knn --active-label-budgets 64 --model-holdout-variance-threshold 0.025 --model-holdout-error-threshold 0.10 --model-holdout-min-state-size 8 --model-holdout-max-split-fraction 1.0 --allow-extra-repair-states
```
