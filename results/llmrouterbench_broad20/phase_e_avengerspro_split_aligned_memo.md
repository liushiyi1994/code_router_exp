...
Command: `python experiments/17_avengerspro_split_aligned.py --config configs/llmrouterbench_broad20.yaml`

Run assets: `results/llmrouterbench_broad20/avengerspro_split_aligned`.
...
| --- | --- | --- | --- | --- |
| avengerspro_simple_cluster_k16 | 0.6574 | 0.2585 | -0.2181 | 2.6428 |
| avengerspro_balance_cluster_k16_w0.7_c0.3 | 0.6449 | 0.2710 | -0.2768 | 2.0805 |
